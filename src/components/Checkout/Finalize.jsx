...
const Finalize = () => {
    return (
        <div className='flex flex-col gap-[20px] w-full items-center'>
            ...
            <p className='mx-[100px] text-center'>Thank you for your purchase! Your order has been successfully processed. We’ll send a confirmation email with tracing details one your items ships</p>
