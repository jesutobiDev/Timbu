  ...
  return (
    <div className='relative m-5 md:m-0 md:mx-[50px] md:my-20 rounded-[25px] overflow-hidden h-[650px] p-12 flex items-end'>
        ...
        <div className='bg-[#121211] absolute z-50 h-auto rounded-[20px] w-[500px] p-10 text-[#F3F2E8]'>
            <p className='font-semibold text-[42px]'>About Timbu</p>
            <p className='text-[14px] tracking-wider leading-[25px] mb-4'>Timbu redefines modern living through minimalist furniture design. Our collection celebrates simplicity with clean lines, premium natural materials, and thoughtful craftsmanship that strips away the unnecessary. Experience the beauty of intentional, understated elegance in versatile pieces made to elevate any interior space.</p>
