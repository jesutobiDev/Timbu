            ...
            <div className="flex justify-between text-[#121211] items-center">
                ...
                {/* <div className="flex gap-2 items-center flex-wrap">
                    {filters.map((filter, index) => (
                        <div
                            key={index}
                            className={`w-[120px] h-[45px] rounded-full flex items-center justify-center cursor-pointer transition-all duration-500 font-medium ${filter.clicked ? 'bg-[#121211] text-[#F3F2E8]' : 'bg-transparent  text-[#121211] border-[2px] border-[#121211]'}`}
